  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      ...
      <div className="absolute top-[8%] w-full flex flex-col gap-5">
        <Marquee text="MECANISMO DE CAMPO  ·  SÍNTESE ATIVA  ·  DOMÍNIO TERRITORIAL  ·  TOXICIDADE CONTROLADA" direction={1} speed={60} opacity={0.055} />
        <Marquee text="SAFRA DE ELITE  ·  ESTRUTURA TÉCNICA  ·  LIDA BRUTA  ·  AGROTÓXICA  ·  COLEÇÃO 2026" direction={-1} speed={45} opacity={0.038} size="text-sm" />
      </div>

      <div className="absolute bottom-[8%] w-full flex flex-col gap-5">
        <Marquee text="MARCHA NO MAQUINÁRIO  ·  ENGENHARIA DA TERRA  ·  ZONA DE IMPACTO  ·  REINANDO NO MATO" direction={-1} speed={52} opacity={0.05} />
        <Marquee text="AGROTÓXICA  ·  2026  ·  GENÉTICA IMPLACÁVEL  ·  TRAIA DE RESPEITO  ·  MADE TO LAST" direction={1} speed={68} opacity={0.033} size="text-sm" />
      </div>
        ...
        >
          <div className="bg-agro-card rounded-3xl p-6 shadow-2xl aspect-[4/5] flex flex-col justify-between border-2 border-transparent group-hover:border-agro-gold transition-all duration-500 overflow-hidden relative">
            ...
            <div className="mt-4 overflow-hidden">
              <motion.h4 className="font-space font-bold text-4xl uppercase leading-none overflow-hidden">
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <motion.span className="text-xs font-poppins font-bold uppercase tracking-widest text-agro-blue opacity-0 group-hover:opacity-50 transition-all duration-500 -translate-x-3 group-hover:translate-x-0">
                  Ver →
                </motion.span>
              </div>
            </div>

            <motion.div className="absolute bottom-0 left-0 h-1 bg-agro-gold rounded-full"
              initial={{ width: '0%' }}
        ...
        >
          ...
          <div className="container mx-auto px-6 pt-32 relative z-10">
            <header className="mb-20">
              ...
              >
                <motion.span className="inline-block w-8 h-[2px] bg-agro-gold"
              ...
              <motion.div className="h-[3px] bg-gradient-to-r from-agro-gold via-agro-blue to-transparent mt-4 rounded-full"
                initial={{ scaleX: 0, originX: 0 }} animate={{ scaleX: 1 }}
                transition={{ duration: 1.2, delay: 0.9, ease: [0.22, 1, 0.36, 1] }}
                style={{ width: '60%' }}
              />

              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 0.45 }}
                transition={{ delay: 1.2, duration: 1 }}
                className="font-poppins text-xs uppercase tracking-[0.3em] mt-4 text-agro-blue"
              >
                {products.length} mecanismos disponíveis
              </motion.p>
            </header>
